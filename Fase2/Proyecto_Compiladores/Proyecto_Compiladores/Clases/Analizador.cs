            ...
            else if (texto[tem] == '\'') //Esto quiere decir que es un token
            {
                if ((tem + 2) < texto.Length)
                {
                    if (texto[tem + 2] == '\'')
                    {
                        ...
                        else
                        {
                            ...
                            {                                
                                ...
                                {
                                    int temp_x = Lista_Tokens[Lista_Tokens.Count - 1].Numero_Token;
                                    Token nuevoToken = new Token(temp_x + 1, '\'' + texto[tem + 1].ToString().ToLower() + '\'', 0, "");
                                    Lista_Tokens.Add(nuevoToken);
                                }
                            }
                        }
                    ...
                    if (texto[tem] == '\'') //Meter posible validación con los keywords
                    {
                        if (Lista_Tokens.Count == 0)
                        {
                            Token nuevoToken = new Token(1, '\'' + palabrita.ToLower() + '\'', 0, "");
                            Lista_Tokens.Add(nuevoToken);
                        }
                        else
                        {
